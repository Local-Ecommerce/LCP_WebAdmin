...
import { AddCircle, Search, DoubleArrow, ArrowRight, LocationOn } from '@mui/icons-material';
...
const Poi = () =>  {
    ...
    const [poiTyping, setPoiTyping] = useState('');
    ...
    }, [change, limit, page, status, poiSearch, type, apartment]);
                ...
                <TableWrapper>
                    {
                        ...
                        <NoItemWrapper>
                            ...
                            <NoItemText>
                                Chọn chung cư để xem các điểm thú vị thuộc quản lí của chung cư.
                            </NoItemText>
                        </NoItemWrapper>
                        :
                        <>
                            <Row mb>
                                <SearchBar>
                                    <StyledSearchIcon />
                                    <Input id="poiSearch" placeholder="Tìm kiếm điểm thú vị" onChange={handleSetPoiSearch} />
                                    <Button onClick={() => clearPoiSearch()}>Clear</Button>
                                </SearchBar>
