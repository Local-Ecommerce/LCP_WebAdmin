            ...
            <ModalContentWrapper>
                {
                    ...
                    <>Bạn có chắc muốn ngưng hoạt động cư dân【<b>{toggleStatusItem ? toggleStatusItem.name : ''}</b>】?</>
                    :
                    <>Cho cư dân【<b>{toggleStatusItem ? toggleStatusItem.name : ''}</b>】hoạt động trở lại?</>
                }
            </ModalContentWrapper>
            <ModalButtonWrapper>
