            ...
            <ModalContentWrapper>
                <LeftWrapper>
                    ...
                    <ContentWrapper>
                        ...
                        <TextField
                            disabled={true}
                            type="text" value={item.ResidentId && item.Resident && item.Resident.ResidentName ? item.Resident.ResidentName : "Admin"}
                        />

                        <FieldLabel mt>Chung cư</FieldLabel>
                        <TextField
                            disabled={true}
                            type="text" value={item.ApartmentId && item.Apartment && item.Apartment.ApartmentName ? item.Apartment.ApartmentName : "Hệ thống"}
                        />
