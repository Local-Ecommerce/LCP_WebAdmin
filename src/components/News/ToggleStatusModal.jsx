            ...
            <ModalContentWrapper>
                {
                    ...
                    <>Bạn có chắc muốn ngưng hoạt động tin tức【<b>{toggleStatusItem ? toggleStatusItem.name : ''}</b>】?</>
                    :
                    <>Cho tin tức【<b>{toggleStatusItem ? toggleStatusItem.name : ''}</b>】hoạt động trở lại?</>
                }
            </ModalContentWrapper>
            <ModalButtonWrapper>
