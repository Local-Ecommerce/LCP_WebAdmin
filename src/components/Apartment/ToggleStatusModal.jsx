            ...
            <ModalContentWrapper>
                {
                    ...
                    <>Bạn có chắc muốn ngưng hoạt động chung cư【<b>{toggleStatusItem ? toggleStatusItem.name : ''}</b>】?</>
                    :
                    <>Cho chung cư【<b>{toggleStatusItem ? toggleStatusItem.name : ''}</b>】hoạt động trở lại?</>
                }
            </ModalContentWrapper>
            <ModalButtonWrapper>
