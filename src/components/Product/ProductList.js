...
const ProductList = ({ currentItems, handlePageClick, pageCount, handleDeleteItem }) => {
            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <TableHeader width="30%">Tên sản phẩm</TableHeader>
                        <TableHeader width="15%">Loại sản phẩm</TableHeader>
